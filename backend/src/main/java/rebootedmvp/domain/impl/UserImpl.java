...
// try {
// List<rebootedmvp.dto.UserCourseDTO> userCourses =
// courseMembershipService.getUserCourses(this.name);
...
// @Override
// public Course getCourse(String courseName) throws
// InaccessibleCourseException, CourseDoesNotExistException {
// // TODO: Implement proper course lookup once CourseService has database
// // integration
// // For now, check if user has access (which validates the course exists in
// their
// // list)
...
// // This will be properly implemented when CourseService is migrated to use
// // repositories
// throw new UnsupportedOperationException(
// "Course lookup by title not yet implemented - requires CourseService database
// migration");
...
// /**
// * Remove a course from the user's local course set (for backward
// compatibility)
// */
